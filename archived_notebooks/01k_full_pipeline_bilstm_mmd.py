...
def train_gan(X_real, y_cond, decoder):
    ...
    @tf.function
    def train_generator_with_physics(cond, lambda_phys=LAMBDA_PHYS):
...
def compute_mmd(X, Y, gamma=1.0):
    """Computes Maximum Mean Discrepancy squared using RBF kernel."""
...
def evaluate_and_generate(generator, decoder, X_real, y_cond):
    """Runs KDE, t-SNE, PCA, MMD, generates filtered synthetic dataset, and denormalizes."""
    n_samples = 10000
